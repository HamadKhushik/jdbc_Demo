...
// this class selects * from employees belonging to a specific city

public class SelectAllAddressBasedRowsExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sql_query = String.format("select * from employees where eaddr= '%s'" , cityName);
