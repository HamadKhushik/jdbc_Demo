...
public class EmployeeWithNthHeighestSalary {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sql_query = String.format("select * from (select eno, ename, esal, eaddr, rank() over (order by esal desc) ranking from employees)where ranking = %d", n);
        // working on rank() query on this db
